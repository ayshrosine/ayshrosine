...
function buildProfileLines(projects) {
  ...
  return [
    { type: "header", value: "ayshrosine@dev" },
    { type: "row", key: "Name", value: "Ayush Bisen" },
    { type: "row", key: "Role", value: "Full Stack Developer" },
    { type: "row", key: "Based", value: "Nagpur, India" },
    { type: "row", key: "Mode", value: "Building / Shipping / Learning" },
    { type: "blank" },
    { type: "section", value: "BUILD.FOCUS" },
    { type: "row", key: "Product", value: "Full-stack SaaS products" },
    { type: "row", key: "AI", value: "AI-powered workflows" },
    { type: "row", key: "Web", value: "React + Node + APIs" },
    { type: "row", key: "Quality", value: "System design + delivery" },
    { type: "blank" },
...
<title id="title">Ayush Bisen - Full Stack Developer</title>
<desc id="description">A builder profile card with Ayush Bisen's high-contrast ASCII portrait, product focus, and selected work.</desc>
<defs>
...
<text x="${titleCenter}" y="${titlebar.y + titlebar.height / 2 + 5}" text-anchor="middle" class="terminal-label">ayshrosine@dev ~ % ./profile</text>
